...
*Supersedes `DEMO_SCRIPT_v189.md`. The Contracting Officer Package now treats
clauses as applicability prompts, not automatic consequences of DD Form 254
selections.*
...
the contracting officer. It separately checks eligibility and safeguarding,
Item 12, Item 13 and its attachments, CUI direction, lifecycle, and signed
distribution. Its clause section is deliberately called an applicability
review: the form's selections do not replace the current FAR/DFARS matrix or
the contracting officer's acquisition-specific determination. Neither export
is the official form and both say so on their face.
