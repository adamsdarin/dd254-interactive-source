...
Codex Astra v1.15.0 / Tool v2.128, 14 September 2026.
...
that drops it; the export inherits the handling limits below. This release adds
no automatic sending or remote lookup.
