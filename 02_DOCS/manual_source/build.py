...
st_p =S(name='p',fontName='Helvetica',fontSize=9.6,leading=14.2,textColor=colors.HexColor('#1a1e26'),spaceAfter=5,alignment=TA_LEFT,allowWidows=0,allowOrphans=0)
