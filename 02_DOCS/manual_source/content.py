...
("h2","DD254 Interactive v2.0.1 changes"),
...
("h2","DD254 Interactive v2.0.0 changes"),
...
("h2","DD254 Interactive v1.16.0 changes"),
...
("h2","DD254 Interactive v1.15.7 changes"),
...
("h2","DD254 Interactive v1.15.6 changes"),
...
("h2","DD254 Interactive v1.15.5 changes"),
...
("b","<b>Redraft</b> on a revision summary can compare with any earlier issuance in the chain, such as the Original, not only the one the Revision was spawned from. See 4.20."),
("b","<b>Fixed:</b> a long confirmation, such as the review of missing Item 13 language, ran off the screen with its buttons out of reach. Every dialog now fits the window and scrolls inside."),
("h2","DD254 Interactive v1.15.4 changes"),
...
("h2","DD254 Interactive v1.15.3 changes"),
...
("h2","DD254 Interactive v1.15.2 changes"),
...
("h2","DD254 Interactive v1.15.1 changes"),
...
("h2","DD254 Interactive v1.15.0 changes"),
...
("h2","DD254 Interactive v1.14.1 changes"),
...
("h2","DD254 Interactive v1.14.0 changes"),
...
("note","A contract is SAP or non-SAP for its whole life. On an Original, Revision or Final spawned on the dashboard, a SAP flag that differs from the issuance it was spawned from is a blocking error: either the flag is wrong, or the work is a different contract and belongs on a new DD-254."),
("h2","2.3 One tab only"),
...
("b","Every field that prints is compared with the issuance the Revision was spawned from, unless you choose another with Redraft. Item 3 dates and numbers are not listed. Boxes read <b>added</b> or <b>removed</b>; short entries show both values; long text such as Item 9 says <b>revised</b>; Item 13 changes are named by Reference section."),
...
("b","When there is more than one earlier issuance, <b>Redraft</b> asks which to summarize from: the one the Revision was spawned from, the Original, or any Revision in between. The heading names the choice, and it is kept with the draft for later updates. The point-of-contact warning still compares with the issuance the Revision was spawned from, because it is about this revision."),
("b","Spawning the next Revision or a Final drops the previous summary, because a summary describes one revision. A new Revision starts from its own parent."),
