...
- **Classification guides linked to contracts.** Link each guide to contracts from
  the DD-254 Template Language library; on those contracts' forms its guides are
  listed first and marked.
- **Reasons optional, if you choose.** A Settings choice, off by default, lets you
  set a finding aside, mark a DD-254 Blocked or cancel one without typing why. The
  action is still logged as "No reason given".
